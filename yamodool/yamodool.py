...
class YAModool(object):
    ...
    def parse_yml_data(self):
        ...
        self.add_optional_attr('_rec_name', 'rec_name')
        self.add_optional_attr('_date_name', 'date_name')
        self.add_optional_attr('_fold_name', 'fold_name')
        self.add_optional_attr('_description', 'description')
        self.add_optional_attr('_inherit', 'inherit')
        self.add_optional_attr('_parent_store', 'parent_store')
        self.add_optional_attr('_parent_name', 'parent_name')
        self.add_optional_attr('_parent_order', 'parent_order')
        self.add_fields()
